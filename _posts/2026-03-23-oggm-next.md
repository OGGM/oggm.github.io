---
layout: post
title: "OGGM-Next: Securing the Future of Global Glacier Modelling"
subtitle: "A new 12-month project to modernise OGGM and prepare it for the next decade of cryospheric science."
...
The project is funded by the UK Research Software Maintenance Fund to officially start in April 2026.

## Why OGGM-Next?

Over the past decade, OGGM has grown into a widely used, community-driven model capable of simulating all ~280,000 glaciers worldwide. It underpins scientific studies, contributes to IPCC assessments, and supports applications ranging from hydrology to climate risk analysis.

At the same time, OGGM is now showing its age. Its architecture dates back to 2015, and while it has evolved continuously, parts of the system are increasingly difficult to maintain, extend, or adapt to modern workflows.
...
**OGGM-Next is about making sure OGGM keeps up.**

## Project overview

- **Duration:** 12 months (March 2026 – February 2027)
- **Funding:** £150,000 (£187,000 FEC)
- **Lead:** Fabien Maussion (University of Bristol)
- **Co-leads:** Francesca Pianosi, James Thomas
- **Core team:** Nicolas Gampierakis (RSE), Chloe Hancock (RIA), Richard Westaway (project management)
