...
<figure>
    ...
    <img src="/img/blog/hef-vanishing-open-air-laboratory/hintereisferner1-220621-1330-hu.jpg" alt="Image missing" width="60%" />
    </a>
 ...
 <br/> Although, the OGGM community here in Innsbruck works on large-scale glacier modelling, we still have a special relation to the Hintereisferner: Hintereisferner is often used as a [test glacier to check regularly our existing code](https://github.com/OGGM/oggm/blob/157c44b5b63c2a848ffb318afe77da4a18223a0d/oggm/tests/conftest.py#L266) and also when starting new workflows, I use Hintereisferner as first test before repeating it on many other glaciers. In addition, many of us have contributed to mass-balance observations on that glacier ourselves. 
 
Over the last months, I recognized, that for Hintereisferner and many other reference glaciers with additional observational data, the model projects very fast melting rates in the near future. That means reference glaciers are almost or even completely lost in the year 2100. Consequently, the uncertainties of volume changes for those vanished glaciers are zero when looking at the year 2100. After some discussions with [Dave](https://www.cmu.edu/cee/people/faculty/rounce.html), we thought about another measure, i.e. the year where half of a glaciers' volume is lost. When I computed that year, it was a bit shocking: 
...
<figure>
    ...
    <img src="/img/blog/hef-vanishing-open-air-laboratory/volume_projections_HEF_glacier_most_complex_easy.jpg" alt="Image missing" width="50%" />
    </a>
